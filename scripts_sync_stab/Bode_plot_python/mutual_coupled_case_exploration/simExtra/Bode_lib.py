...
def HopenloopMutuallyCoupledOnePLL(w, Omega, tau, tauf, tauc, v, Kvco, AkPD, GkLF, Gvga, digital, model):
	return ( LoopGainSteadyState(Omega, tau, tauf, v, Kvco, AkPD, GkLF, Gvga, digital, model)/( 1j*w*( 1.0 + 1j*w*tauc ) ) )

def PhaseopenloopMutuallyCoupledOnePLL(w, Omega, tau, tauf, tauc, v, Kvco, AkPD, GkLF, Gvga, digital, model):
	phase =	 cmath.phase(HopenloopMutuallyCoupledOnePLL(w, Omega, tau, tauf, tauc, v, Kvco, AkPD, GkLF, Gvga,  digital, model))
	return 360.0*phase/(2.0*np.pi)


def HclosedloopMutuallyCoupledOnePLL(w, Omega, tau, tauf, tauc, v, Kvco, AkPD, GkLF, Gvga, digital, model):

	return HopenloopMutuallyCoupledOnePLL(w, Omega, tau, tauf, tauc, v, Kvco, AkPD, GkLF, Gvga, digital, model)/( 1.0 + HopenloopMutuallyCoupledOnePLL(w, Omega, tau, tauf, tauc, v, Kvco, AkPD, GkLF, Gvga, digital, model)*np.exp(1j*w*( -tauf ) ) )
	# return ((alpha*np.exp(1j*w*(-tauf))/(1j*w*(1+1j*w*tauc)))/(1.0+(alpha/(1j*w*(1+1j*w*tauc)))))


def PhaseclosedloopMutuallyCoupledOnePLL(w, Omega, tau, tauf, tauc, v, Kvco, AkPD, GkLF, Gvga,  digital, model):
	phase =	 cmath.phase(HclosedloopMutuallyCoupledOnePLL(w, Omega, tau, tauf, tauc, v, Kvco, AkPD, GkLF, Gvga,  digital, model))
	return 360.0*phase/(2.0*np.pi)




def HopenloopMutuallyCoupledNet(w, Omega, tau, tauf, tauc, v, Kvco, AkPD, GkLF, Gvga,  digital, model):

	return (np.exp(-2.0*1j*w*tau)*(HclosedloopMutuallyCoupledOnePLL(w, Omega, tau, tauf, tauc, v, Kvco, AkPD, GkLF, Gvga,  digital, model))**2 )

	# return (np.exp(-2*1j*w*tau)*((alpha*np.exp(1j*w*(-tauf))/(1j*w*((1+1j*w*tauc)) ))/(1.0+(alpha*np.exp(1j*w*(-tauf))/(1j*w*((1+1j*w*tauc)) ))))**2)

def HopenloopMutuallyCoupledNet2(w, Omega, tau, tauf, tauc, v, Kvco, AkPD, GkLF, Gvga,  digital, model):

	return (np.exp(-1j*w*tau )*( 1.0/HopenloopMutuallyCoupledOnePLL( w, Omega, tau, tauf, tauc, v, Kvco, AkPD, GkLF, Gvga, digital )+1.0) )

def PhaseopenloopMutuallyCoupledNet(w, Omega, tau, tauf, tauc, v, Kvco, AkPD, GkLF, Gvga,  digital, model):
	phase =	 cmath.phase(HopenloopMutuallyCoupledNet(w, Omega, tau, tauf, tauc, v, Kvco, AkPD, GkLF, Gvga,  digital, model))
	return 360.0*phase/(2.0*np.pi)



def HclosedloopMutuallyCoupledNet(w, Omega, tau, tauf, tauc, v, Kvco, AkPD, GkLF, Gvga,  digital, model):
	...
	return HopenloopMutuallyCoupledNet(w, Omega, tau, tauf, tauc, v, Kvco, AkPD, GkLF, Gvga,  digital, model)/(1.0-HopenloopMutuallyCoupledNet(w, Omega, tau, tauf, tauc, v, Kvco, AkPD, GkLF, Gvga,  digital, model))

def PhaseclosedloopMutuallyCoupledNet(w, Omega, tau, tauf, tauc, v, Kvco, AkPD, GkLF, Gvga,  digital, model):
	phase =	 cmath.phase(HopenloopMutuallyCoupledNet(w, Omega, tau, tauf, tauc, v, Kvco, AkPD, GkLF, Gvga,  digital, model))
	return 360.0*phase/(2.0*np.pi)
...
def GainMarginMutuallyCoupledNet(w, Omega, tau, tauf, tauc, v, Kvco, AkPD, GkLF, Gvga,  digital, model):

	realpart=HopenloopMutuallyCoupledNet(w, Omega, tau, tauf, tauc, v, Kvco, AkPD, GkLF, Gvga,  digital, model).real
	imagpart=HopenloopMutuallyCoupledNet(w, Omega, tau, tauf, tauc, v, Kvco, AkPD, GkLF, Gvga,  digital, model).imag
...
def PhaseMarginMutuallyCoupledNet(w, Omega, tau, tauf, tauc, v, Kvco, AkPD, GkLF, Gvga,  digital, model):
...
def GainMarginMutuallyCoupledOne(w, Omega, tau, tauf, tauc, v, Kvco, AkPD, GkLF, Gvga,  digital, model):

	realpart=HopenloopMutuallyCoupledOnePLL(w, Omega, tau, tauf, tauc, v, Kvco, AkPD, GkLF, Gvga,  digital, model).real
	imagpart=HopenloopMutuallyCoupledOnePLL(w, Omega, tau, tauf, tauc, v, Kvco, AkPD, GkLF, Gvga,  digital, model).imag
...
def PhaseMarginMutuallyCoupledOne(w, Omega, tau, tauf, tauc, v, Kvco, AkPD, GkLF, Gvga,  digital, model):
