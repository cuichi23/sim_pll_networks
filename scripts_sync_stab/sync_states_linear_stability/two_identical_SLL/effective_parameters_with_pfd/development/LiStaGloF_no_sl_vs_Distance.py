...
[lineOmegStab] = ax.plot(np.asarray(c)*solveLinStab(globalFreq(w, K, tauf, v, digital, maxp)['Omeg'], globalFreq(w, K, tauf, v, digital, maxp)['tau'], tauf, K, tauc, v, digital, maxp, expansion)['tauStab'],
						 solveLinStab(globalFreq(w, K, tauf, v, digital, maxp)['Omeg'], globalFreq(w, K, tauf, v, digital, maxp)['tau'],tauf, K, tauc, v, digital, maxp, expansion)['OmegStab']/np.asarray(w),
						 '.',ms=1, color='blue', label=r'$\Omega_{st} v	 = 16.0, c=		3E8$')

[lineOmegUnst] = ax.plot(np.asarray(c)*solveLinStab(globalFreq(w, K, tauf, v, digital, maxp)['Omeg'],globalFreq(w, K, tauf, v, digital, maxp)['tau'], tauf, K, tauc, v, digital, maxp, expansion)['tauUnst'],
						 solveLinStab(globalFreq(w, K, tauf, v, digital, maxp)['Omeg'],globalFreq(w, K, tauf, v, digital, maxp)['tau'], tauf, K, tauc, v, digital, maxp, expansion)['OmegUnst']/np.asarray(w),
						 'o',ms=1, color='red', label=r'$\Omega_{un},  w  = 2.0\pi*24 GHz, K    = 4\pi*25MHz tauc =0.5(1/w)$')
...
[lineSigma] = ax1.plot(np.asarray(c)*globalFreq(w, K, tauf, v, digital, maxp)['tau'], np.asarray(2.0*np.pi/w)*solveLinStab(globalFreq(w, K, tauf, v, digital, maxp)['Omeg'],
...
[lineGamma] = ax1.plot(np.asarray(c)*globalFreq(w, K, tauf, v, digital, maxp)['tau'],np.asarray(1/w)*solveLinStab(globalFreq(w, K, tauf, v, digital, maxp)['Omeg'],
	globalFreq(w, K, tauf, v, digital, maxp)['tau'], tauf_0, K_0, tauc_0, v_0, digital,maxp, expansion)['Im'],	'.', ms=1, color='blue', label=r'$\gamma$=Im$(\lambda)$')
