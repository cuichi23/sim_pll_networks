...
[lineSigmaIn] = ax8.plot(np.asarray(globalFreq(wref, w, Kvco, AkPD, GkLF,Gvga, tauf, v, digital, maxp, sync_state1, INV)['Omeg']/(2.0*np.pi))*globalFreq(wref, w, Kvco, AkPD, GkLF,Gvga, tauf, v, digital, maxp, sync_state1, INV)['tau'],
	np.asarray(2.0*np.pi/w)*solveLinStab(wref, w, globalFreq(wref, w, Kvco, AkPD, GkLF,Gvga, tauf, v, digital, maxp, sync_state1, INV)['Omeg'],
	globalFreq(wref, w, Kvco, AkPD, GkLF,Gvga, tauf, v, digital, maxp, sync_state1, INV)['tau'], tauf, Kvco, AkPD, GkLF,Gvga, tauc, v, digital, maxp, sync_state1, expansion, INV)['ReMax'],
	 '-', linewidth=1, color='green', label=r'$\sigma$ in-phase')
[lineGammaIn] = ax8.plot(np.asarray(globalFreq(wref, w, Kvco, AkPD, GkLF,Gvga, tauf, v, digital, maxp, sync_state1, INV)['Omeg']/(2.0*np.pi))*globalFreq(wref, w, Kvco, AkPD, GkLF,Gvga, tauf, v, digital, maxp, sync_state1, INV)['tau'],
	np.asarray(1.0/w)*solveLinStab(wref, w, globalFreq(wref, w, Kvco, AkPD, GkLF,Gvga, tauf, v, digital, maxp, sync_state1, INV)['Omeg'],
	globalFreq(wref, w, Kvco, AkPD, GkLF,Gvga, tauf, v, digital, maxp, sync_state1, INV)['tau'], tauf, Kvco, AkPD, GkLF,Gvga, tauc, v, digital, maxp, sync_state1, expansion, INV)['ImMax'],
	 '.', ms=2, color='green', label=r'$\gamma$ in-phase')
plt.grid();
# ax8.legend();
#
if digital == True:
