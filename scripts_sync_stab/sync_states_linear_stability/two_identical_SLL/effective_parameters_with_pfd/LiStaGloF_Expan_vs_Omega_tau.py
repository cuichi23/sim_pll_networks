...
from LiStaGloF_lib import solveLinStab, globalFreq,linStabEq,linStabEq_expansion,initial_guess
...
[lineOmegStab] = ax.plot(np.asarray(w/(2.0*np.pi))*solveLinStab(globalFreq(w, K, tauf, v, digital, maxp)['Omeg'],
				...
				globalFreq(w, K, tauf, v, digital, maxp)['tau'],tauf, K, tauc, v, digital, maxp, expansion)['OmegStab'],
...
[lineOmegUnst] = ax.plot(np.asarray(w/(2.0*np.pi))*solveLinStab(globalFreq(w, K, tauf, v, digital, maxp)['Omeg'],
				globalFreq(w, K, tauf, v, digital, maxp)['tau'], tauf, K, tauc, v, digital, maxp, expansion)['tauUnst']*solveLinStab(globalFreq(w, K, tauf, v, digital, maxp)['Omeg'],
...
[lineGamma1] = ax1.plot(np.asarray(w/(2.0*np.pi))*globalFreq(w, K, tauf, v, digital, maxp)['Omeg']*globalFreq(w, K, tauf, v, digital, maxp)['tau'], np.asarray(1/w)*solveLinStab(globalFreq(w, K, tauf, v, digital, maxp)['Omeg'],
