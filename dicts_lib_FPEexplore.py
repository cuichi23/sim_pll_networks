...
def getDicts(Fsim=125):
	...
	dict_algo={
		'parameter_space_sweeps': 'listOfInitialPhaseConfigurations',		# pick method for setting realizations 'single,' 'classicBruteForceMethodRotatedSpace', 'listOfInitialPhaseConfigurations', 'statistics', 'two_parameter_sweep', 'one_parameter_sweep'
