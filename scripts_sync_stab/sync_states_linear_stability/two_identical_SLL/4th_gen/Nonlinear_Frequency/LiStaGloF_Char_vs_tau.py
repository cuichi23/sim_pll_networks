...
from LiStaGloF_lib import solveLinStab, globalFreq, linStabEq,globalFreqNonlinear, solveLinStabNonliner,NonlinearFreqResponse #,globalFreqKrange
...
w    	  	= 2.0*np.pi*63.20E9;		# intrinsic	frequency63193
Kvco      	= 2.0*np.pi*(800E6); 		# Sensitivity of VCO
KvcoMax		= 2.0*np.pi*(1.02E9);		# Max Sensitivity of VCO
KvcoMin		= 2.0*np.pi*(0.6E9);		# Min Sensitivity of VCO
Vcoarse		= 4.0
...
print(NonlinearFreqResponse(AkPD, GkLF, Gvga, np.pi/2, Vcoarse, INV,digital)/(2.0*np.pi))
...
# #*******************************************************************************
[lineOmegStabInK] = ax.plot(np.asarray(wnormx/(2.0*np.pi))*solveLinStab(globalFreq(w, Kvco, AkPD, GkLF,Gvga, tauf, v, digital, maxp, inphase1, INV)['Omeg'], globalFreq(w, Kvco, AkPD, GkLF,Gvga, tauf, v, digital, maxp, inphase1, INV)['tau'], tauf, Kvco, AkPD, GkLF,Gvga, tauc, v, order, digital, maxp, inphase1, expansion, INV, filter)['tauStab'],
						 np.asarray(1/(2.0*np.pi))*solveLinStab(globalFreq(w,Kvco, AkPD, GkLF,Gvga,tauf, v, digital, maxp, inphase1, INV)['Omeg'], globalFreq(w, Kvco, AkPD, GkLF,Gvga, tauf, v, digital, maxp, inphase1, INV)['tau'], tauf, Kvco, AkPD, GkLF,Gvga, tauc, v, order, digital, maxp, inphase1, expansion, INV, filter)['OmegStab'],
						'o',ms=7, color='green',  label=r'Inphase Stable Kvco=800MHz')

[lineOmegUnstIn] = ax.plot(np.asarray(wnormx/(2.0*np.pi))*solveLinStab(globalFreq(w, Kvco, AkPD, GkLF,Gvga, tauf, v, digital, maxp, inphase1, INV)['Omeg'],globalFreq(w, Kvco, AkPD, GkLF,Gvga, tauf, v, digital, maxp, inphase1, INV)['tau'],
 							tauf, Kvco, AkPD, GkLF,Gvga, tauc, v, order, digital, maxp, inphase1, expansion, INV, filter)['tauUnst'],
						 np.asarray(1/(2.0*np.pi))*solveLinStab(globalFreq(w, Kvco, AkPD, GkLF,Gvga, tauf, v, digital, maxp, inphase1, INV)['Omeg'],globalFreq(w, Kvco, AkPD, GkLF,Gvga, tauf, v, digital, maxp, inphase1, INV)['tau'], tauf, Kvco, AkPD, GkLF,Gvga, tauc, v, order, digital, maxp, inphase1, expansion, INV, filter)['OmegUnst'],
						  'o',ms=1, color='green', label=r'Inphase Unstable Kvco=800MHz')
#
#
#
...
# #															solveLinStabNonliner(Omega, tau, tauf, tauc, AkPD, GkLF, Gvga, Vcoarse, v, order, digital, maxp, inphase, expansion, INV, zeta)
[lineOmegStabInNon] = ax.plot(np.asarray(wnormx/(2.0*np.pi))*solveLinStabNonliner(globalFreqNonlinear(AkPD, GkLF, Gvga, Vcoarse, tauf, v, digital, maxp, inphase1, INV)['Omeg'],
						globalFreqNonlinear(AkPD, GkLF, Gvga, Vcoarse, tauf, v,digital, maxp, inphase1, INV)['tau'], tauf, tauc, AkPD, GkLF, Gvga, Vcoarse, v, order, digital, maxp, inphase1, expansion, INV, zeta)['tauStab'],
						np.asarray(1.0/(2.0*np.pi))*solveLinStabNonliner(globalFreqNonlinear(AkPD, GkLF, Gvga, Vcoarse, tauf, v, digital, maxp, inphase1, INV)['Omeg'], globalFreqNonlinear(AkPD,GkLF, Gvga, Vcoarse, tauf, v, digital, maxp, inphase1, INV)['tau'], tauf, tauc, AkPD, GkLF, Gvga, Vcoarse, v, order, digital, maxp, inphase1, expansion, INV, zeta)['OmegStab'], 'o',ms=7, color='red',  label=r'Inphase Stable Nonlinear Response')

[lineOmegUnstInNon] = ax.plot(np.asarray(wnormx/(2.0*np.pi))*solveLinStabNonliner(globalFreqNonlinear(AkPD, GkLF, Gvga, Vcoarse, tauf, v, digital, maxp, inphase1, INV)['Omeg'],
								globalFreqNonlinear(AkPD, GkLF, Gvga, Vcoarse, tauf, v, digital, maxp, inphase1, INV)['tau'], tauf, tauc, AkPD, GkLF, Gvga, Vcoarse, v, order, digital, maxp, inphase1, expansion, INV, zeta)['tauUnst'],
						 np.asarray(1/(2.0*np.pi))*solveLinStabNonliner(globalFreqNonlinear(AkPD, GkLF, Gvga, Vcoarse, tauf, v, digital, maxp, inphase1, INV)['Omeg'],
						 globalFreqNonlinear(AkPD, GkLF, Gvga, Vcoarse, tauf, v, digital, maxp, inphase1, INV)['tau'],
						  tauf, tauc, AkPD, GkLF, Gvga, Vcoarse, v, order, digital, maxp, inphase1, expansion, INV, zeta)['OmegUnst'],
						 'o',ms=1, color='red', label=r'Inphase Unstable Nonlinear Response')
#
#
...
# draw the initial plot
[lineSigmaInMax] = ax1.plot(np.asarray(wnormx/(2.0*np.pi))*globalFreq(w, Kvco, AkPD, GkLF,Gvga, tauf, v, digital, maxp, inphase1, INV)['tau'], np.asarray(2.0*np.pi/w)*solveLinStab(globalFreq(w, Kvco, AkPD, GkLF,Gvga, tauf, v, digital, maxp, inphase1,INV)['Omeg'],
	 ...
	 linewidth=4, color='green', label=r'$\sigma$=Re$(\lambda)$ (in-phase),  Kvco=800MHz')
...
# # #
#																																						solveLinStabNonliner(Omega, tau, tauf, tauc, AkPD, GkLF, Gvga, Vcoarse, v, order, digital, maxp, inphase, expansion, INV, zeta)
[lineSigmaInNon] = ax1.plot(np.asarray(wnormx/(2.0*np.pi))*globalFreqNonlinear(AkPD, GkLF, Gvga, Vcoarse, tauf, v, digital, maxp, inphase1, INV)['tau'],np.asarray(2.0*np.pi/w)*solveLinStabNonliner(globalFreqNonlinear(AkPD, GkLF, Gvga, Vcoarse, tauf, v, digital, maxp, inphase1,INV)['Omeg'],
	globalFreqNonlinear(AkPD, GkLF, Gvga, Vcoarse, tauf, v, digital, maxp, inphase1,INV)['tau'], tauf,  tauc, AkPD, GkLF, Gvga, Vcoarse, v, order, digital, maxp, inphase1, expansion, INV, zeta)['ReMax'],
