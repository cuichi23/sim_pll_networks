...
# draw the initial plot
[lineSigmaAll2All]  = ax1.plot(np.asarray(w/(2.0*np.pi))*globalFreq(w, Kvco, AkPD,  GkLF,Gvga, tauf, v, digital, maxp, INV)['tau'], np.asarray((2.0*np.pi)/w)*solveLinStab_topology_comparison(globalFreq(w, Kvco, AkPD,  GkLF,Gvga, tauf, v, digital, maxp, INV)['Omeg'],
...
#
[lineSigmaring]     = ax1.plot(np.asarray(w/(2.0*np.pi))*globalFreq(w, Kvco, AkPD,  GkLF,Gvga, tauf, v, digital, maxp, INV)['tau'], np.asarray((2.0*np.pi)/w)*solveLinStab_topology_comparison(globalFreq(w, Kvco, AkPD,  GkLF,Gvga, tauf, v, digital, maxp, INV)['Omeg'],
