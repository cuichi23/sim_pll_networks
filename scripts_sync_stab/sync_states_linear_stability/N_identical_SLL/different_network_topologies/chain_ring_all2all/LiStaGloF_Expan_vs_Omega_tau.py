...
plt.title(r'solutions to 3rd order exp for $N_x=$%d, $N_y=$%d, $N=N_x\,N_y=$%d,where $\sigma=$Re$(\lambda)$' %(Nx, Ny, Nx*Ny));
plt.grid()
...
[lineSigmaChain] = ax1.plot(np.asarray(1/(2.0*np.pi))*globalFreq(w, K, tauf, v, digital, maxp)['Omeg']*globalFreq(w, K, tauf, v, digital, maxp)['tau'], np.asarray((2.0*np.pi)/w)*solveLinStab_topology_comparison(globalFreq(w, K, tauf, v, digital, maxp)['Omeg'],
	globalFreq(w, K, tauf, v, digital, maxp)['tau'], tauf_0, K_0, tauc_0, v_0, digital,maxp, expansion, eigenvalzeta('chain',Nx,Ny)['zeta'])['ReMax'], '-',linewidth=1.5, color='black', label=r'Re$(\lambda)$ chain')


[lineSigmaring] = ax1.plot(np.asarray(1/(2.0*np.pi))*globalFreq(w, K, tauf, v, digital, maxp)['Omeg']*globalFreq(w, K, tauf, v, digital, maxp)['tau'], np.asarray((2.0*np.pi)/w)*solveLinStab_topology_comparison(globalFreq(w, K, tauf, v, digital, maxp)['Omeg'],
...
# plot grid, labels, define intial values
plt.title(r'solutions to 3rd order exp for $N_x=$%d, $N_y=$%d, $N=N_x\,N_y=$%d,where $\gamma$=Im$(\lambda)$' %(Nx, Ny, Nx*Ny));
plt.grid()
plt.xlabel(r'$\Omega\tau/2\pi$', fontsize=18)
...
[lineGammaChain] = ax2.plot(np.asarray(1/(2.0*np.pi))*globalFreq(w, K, tauf, v, digital, maxp)['Omeg']*globalFreq(w, K, tauf, v, digital, maxp)['tau'], np.asarray(1/w)*solveLinStab_topology_comparison(globalFreq(w, K, tauf, v, digital, maxp)['Omeg'],
	globalFreq(w, K, tauf, v, digital, maxp)['tau'], tauf_0, K_0, tauc_0, v_0, digital,maxp, expansion, eigenvalzeta('chain',Nx,Ny)['zeta'])['ImMax'], '-',linewidth=1.5, color='black', label=r'Im$(\lambda)$ chain')
[lineGammaring] = ax2.plot(np.asarray(1/(2.0*np.pi))*globalFreq(w, K, tauf, v, digital, maxp)['Omeg']*globalFreq(w, K, tauf, v, digital, maxp)['tau'], np.asarray(1/w)*solveLinStab_topology_comparison(globalFreq(w, K, tauf, v, digital, maxp)['Omeg'],
...
def sliders_on_changed(val):
	...
	lineOmeg.set_ydata(solveLinStab_topology_comparison(globalFreq(w, K_slider.val, tauf_slider.val, v_slider.val, digital, maxp)['Omeg'],
						...
						tauf_slider.val, v_slider.val, digital,maxp, expansion, eigenvalzeta('global',Nx,Ny)['zeta'])['Omeg']/np.asarray(w));
	...
	lineSigmaChain.set_xdata(np.asarray(1/(2.0*np.pi))*globalFreq(w, K_slider.val, tauf_slider.val, v_slider.val, digital, maxp)['Omeg']*globalFreq(w, K_slider.val, tauf_slider.val, v_slider.val, digital, maxp)['tau']);
	...
	lineGammaChain.set_xdata(np.asarray(1/(2.0*np.pi))*globalFreq(w, K_slider.val, tauf_slider.val, v_slider.val, digital, maxp)['Omeg']*globalFreq(w, K_slider.val, tauf_slider.val, v_slider.val, digital, maxp)['tau']);
	...
	lineSigmaring.set_xdata(np.asarray(1/(2.0*np.pi))*globalFreq(w, K_slider.val, tauf_slider.val, v_slider.val, digital, maxp)['Omeg']*globalFreq(w, K_slider.val, tauf_slider.val, v_slider.val, digital, maxp)['tau']);
	...
	lineGammaring.set_xdata(np.asarray(1/(2.0*np.pi))*globalFreq(w, K_slider.val, tauf_slider.val, v_slider.val, digital, maxp)['Omeg']*globalFreq(w, K_slider.val, tauf_slider.val, v_slider.val, digital, maxp)['tau']);
