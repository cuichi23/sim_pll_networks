...
def getDicts(Fsim=125):
	...
	dictNet={
		...
		'Tsim': 150000,															# simulation time in multiples of the period
	...
	dictPLL={
		...
		'transmission_delay': 1055,#39968, 											# value of transmission delay in seconds, float (single), list (tau_k) or list of lists (tau_kl): np.random.uniform(min,max,size=[dictNet['Nx']*dictNet['Ny'],dictNet['Nx']*dictNet['Ny']]), OR [np.random.uniform(min,max) for i in range(dictNet['Nx']*dictNet['Ny'])]
