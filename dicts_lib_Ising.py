...
def getDicts(Fsim=125):
	...
	dictPLL={
		...
		'coupK': 0.05, #[random.uniform(0.3, 0.5) for i in range(dictNet['Nx']*dictNet['Ny'])],# coupling strength in Hz float or [random.uniform(minK, maxK) for i in range(dictNet['Nx']*dictNet['Ny'])]
		...
		'coupStr_2ndHarm': 0.35,												# the coupling constant for the injection of the 2nd harmonic: float, will be indepent of 'coupK'
