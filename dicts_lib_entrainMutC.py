...
def getDicts(Fsim=55):
	...
	dict_net = {
		...
		'Tsim': 4400,															# simulation time in multiples of the period
	...
	dict_algo = {
		...
		'paramDiscretization': [13, 13],										# parameter discretization for brute force initial phases and parameter space scans, e.g., for 'listOfInitialPhaseConfigurations' it specifies the number of initial phase differences and the discretization points for 'min_max_range_parameter_0'
		...
		'number_of_processes_in_multisim': 16									# choose there an integer number that specifies the number of parallel threads to be simulated
	}
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
