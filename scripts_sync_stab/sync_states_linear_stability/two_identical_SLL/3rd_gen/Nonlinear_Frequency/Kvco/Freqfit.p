...
#
      ...
      set xlabel "Vcontrol " font "Times-Roman,22"
      set ylabel "Frequency" font "Times-Roman,22"
      set xtics font ", 16"
      set ytics font ", 16"
	...
	#fit[x=-5:3] h(x) "1.txt" using 1:2 via a,b
       ...
       plot "1.txt" using 1:2 pt 7 ps 2 title "data", h(x) title "21.5e9+1.8e9*sqrt(x)" lw 2
