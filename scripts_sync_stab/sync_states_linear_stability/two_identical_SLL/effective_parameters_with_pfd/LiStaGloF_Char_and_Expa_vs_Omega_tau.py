...
c_0		= c;
expansion=True;
[lineSigma] = ax.plot(np.asarray(w/(2.0*np.pi))*globalFreq(w, K, tauf, v, digital, maxp)['Omeg']*globalFreq(w, K, tauf, v, digital, maxp)['tau'], np.asarray(2.0*np.pi/w)*solveLinStab(globalFreq(w, K, tauf, v, digital, maxp)['Omeg'],
	globalFreq(w, K, tauf, v, digital, maxp)['tau'], tauf_0, K_0, tauc_0, v_0, digital,maxp,expansion)['Re'],'-.',ms=0.5, color='red', label=r'$\sigma$=Re$(\lambda)$ (3rd Order Expansion) ')
[lineGamma] = ax.plot(np.asarray(w/(2.0*np.pi))*globalFreq(w, K, tauf, v, digital, maxp)['Omeg']*globalFreq(w, K, tauf, v, digital, maxp)['tau'], np.asarray(1.0/w)*solveLinStab(globalFreq(w, K, tauf, v, digital, maxp)['Omeg'],
	globalFreq(w, K, tauf, v, digital, maxp)['tau'], tauf_0, K_0, tauc_0, v_0, digital,maxp,expansion)['Im'],	'-.',ms=0.5, color='blue', label=r'$\gamma$=Im$(\lambda)$(3rd Order Expansion)')
...
[lineSigma1] = ax.plot(np.asarray(w/(2.0*np.pi))*globalFreq(w, K, tauf, v, digital, maxp)['Omeg']*globalFreq(w, K, tauf, v, digital, maxp)['tau'], np.asarray(2.0*np.pi/w)*solveLinStab(globalFreq(w, K, tauf, v, digital, maxp)['Omeg'],
	globalFreq(w, K, tauf, v, digital, maxp)['tau'], tauf_0, K_0, tauc_0, v_0, digital,maxp,expansion)['Re'],	linewidth=2, color='red', label=r'$\sigma$=Re$(\lambda)$ (Full Expression)')
[lineGamma1] = ax.plot(np.asarray(w/(2.0*np.pi))*globalFreq(w, K, tauf, v, digital, maxp)['Omeg']*globalFreq(w, K, tauf, v, digital, maxp)['tau'], np.asarray(1.0/w)*solveLinStab(globalFreq(w, K, tauf, v, digital, maxp)['Omeg'],
	globalFreq(w, K, tauf, v, digital, maxp)['tau'], tauf_0, K_0, tauc_0, v_0, digital,maxp,expansion)['Im'],	linewidth=2, color='blue', label=r'$\gamma$=Im$(\lambda)$Full Expression)')
...
# 	globalFreq(w, K, tauf, v, digital, maxp)['tau'], tauf_0, K_0, tauc_0, v_0, digital,al)['Re'], solveLinStab(globalFreq(w, K, tauf, v, digital, maxp)['Omeg'],
# 	globalFreq(w, K, tauf, v, digital, maxp)['tau'], tauf_0, K_0, tauc_0, v_0, digital,al)['Im'],	linewidth=2, color='red', label=r'Im$(\lambda)$')
#

# add two sliders for tweaking the parameters
# define an axes area and draw a slider in it
v_slider_ax   = fig.add_axes([0.6, 0.010, 0.35, 0.015], facecolor=axis_color)
v_slider      = Slider(v_slider_ax, r'$v$', 1, 512, valinit=v_0)
# Draw another slider
tauf_slider_ax  = fig.add_axes([0.6, 0.035, 0.35, 0.015], facecolor=axis_color)
tauf_slider     = Slider(tauf_slider_ax, r'$\tau^f$', 0.0, 25.0/w, valinit=tauf_0)#25*(2.0*np.pi/w)
# Draw another slider
K_slider_ax = fig.add_axes([0.05, 0.035, 0.35, 0.015], facecolor=axis_color)
K_slider    = Slider(K_slider_ax, r'$K$', 0.001*w, 1.5*w, valinit=K_0)
# Draw another slider
tauc_slider_ax  = fig.add_axes([0.05, 0.01, 0.35, 0.015], facecolor=axis_color)
...
def sliders_on_changed(val):
	...
	lineSigma.set_xdata(globalFreq(w, K_slider.val, tauf_slider.val, v_slider.val, digital, maxp)['Omeg']*globalFreq(w, K_slider.val, tauf_slider.val, v_slider.val, digital, maxp)['tau']);
	...
	lineGamma.set_xdata(globalFreq(w, K_slider.val, tauf_slider.val, v_slider.val, digital, maxp)['Omeg']*globalFreq(w, K_slider.val, tauf_slider.val, v_slider.val, digital, maxp)['tau']);
