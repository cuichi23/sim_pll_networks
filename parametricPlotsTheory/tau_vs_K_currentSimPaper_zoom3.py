...
dictNet={
	...
	'zeta': [-0.5, 0.25],#[-1, -0.5, 0.5],										# real part of eigenvalue of slowest decaying perturbation mode for the set of parameters, also a fct. of tau!
	'psi': [np.pi, 0],		#[np.pi, np.pi, 0.0],								# real part of eigenvalue of slowest decaying perturbation
...
#tau 	= np.arange(120900, 121100, 1)# 2.5
#K		= 2.0*np.pi*np.arange(0.0001, 0.1, 0.06285/(4.0*np.pi) ) #0.001, 0.4
tau 	= np.arange(120900, 120950, 0.005)# 2.5
K		= 2.0*np.pi*np.arange(0.0001, 0.0035, 0.00006285/(2.0*np.pi) ) #0.001, 0.4
#tau 	= np.arange(0, 16, 0.005)# 2.5
