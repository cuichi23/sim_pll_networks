...
dp		= 0.01;
f             = np.logspace(-2.0,12.0, num=(maxp+tauf)/dp, endpoint=True, base=10.0)
...
print('Omage_tau=',globalFreq(wref, w1, Kvco, AkPD, GkLF,Gvga, tauf, v, digital, maxp, sync_state1)['tau'][-1])
print('tau=',tau1)
										#
