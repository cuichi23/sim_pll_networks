...
[lineOmegStab] = ax.plot(np.asarray(1.0/(2.0*np.pi))*solveLinStab(globalFreq(w, Kvco, AkPD, Ga1, tauf, v, digital, maxp)['Omeg'],
				globalFreq(w, Kvco, AkPD, Ga1, tauf, v, digital, maxp)['tau'], tauf_0, Kvco, AkPD, Ga1_0, tauc_0, v_0, digital, maxp, expansion)['tauStab']*solveLinStab(globalFreq(w, Kvco, AkPD, Ga1, tauf, v, digital, maxp)['Omeg'],
				globalFreq(w, Kvco, AkPD, Ga1, tauf, v, digital, maxp)['tau'],tauf, Kvco, AkPD, Ga1, tauc, v, digital, maxp, expansion)['OmegStab'],
...
[lineOmegUnst] = ax.plot(np.asarray(1.0/(2.0*np.pi))*solveLinStab(globalFreq(w, Kvco, AkPD, Ga1, tauf, v, digital, maxp)['Omeg'],
				globalFreq(w, Kvco, AkPD, Ga1, tauf, v, digital, maxp)['tau'], tauf, Kvco, AkPD, Ga1, tauc, v, digital, maxp, expansion)['tauUnst']*solveLinStab(globalFreq(w, Kvco, AkPD, Ga1, tauf, v, digital, maxp)['Omeg'],
				globalFreq(w, Kvco, AkPD, Ga1, tauf, v, digital, maxp)['tau'],tauf_0, Kvco, AkPD, Ga1_0, tauc_0, v_0,digital, maxp, expansion)['OmegUnst'],
...
[lineGamma1] = ax1.plot(np.asarray(1.0/(2.0*np.pi))*globalFreq(w,Kvco, AkPD, Ga1, tauf, v, digital, maxp)['Omeg']*globalFreq(w, Kvco, AkPD, Ga1, tauf, v, digital, maxp)['tau'], np.asarray(1/w)*solveLinStab(globalFreq(w, Kvco, AkPD, Ga1, tauf, v, digital, maxp)['Omeg'],
...
tauc_slider     = Slider(tauc_slider_ax, r'$\tau^c$', 0.05*1.0/(2.0*np.pi*120E6), 1.0/(2.0*np.pi*120E6), valinit=tauc_0)
...
def sliders_on_changed(val):
	...
	lineOmegStab.set_xdata(np.asarray(1.0/(2.0*np.pi))*solveLinStab(globalFreq(w, Kvco, AkPD, Ga1_slider.val, tauf_slider.val, v_slider.val, digital, maxp)['Omeg'],
						globalFreq(w, Kvco, AkPD, Ga1_slider.val, tauf_slider.val, v_slider.val, digital, maxp)['tau'], tauf_slider.val, Kvco, AkPD, Ga1_slider.val, tauc_slider.val, v_slider.val, digital,maxp, expansion)['tauStab']*solveLinStab(globalFreq(w, Kvco, AkPD, Ga1_slider.val, tauf_slider.val, v_slider.val, digital, maxp)['Omeg'],
						globalFreq(w, Kvco, AkPD, Ga1_slider.val, tauf_slider.val, v_slider.val, digital, maxp)['tau'], tauf_slider.val, Kvco, AkPD, Ga1_slider.val,
						tauc_slider.val, v_slider.val, digital,maxp, expansion)['OmegStab']);
	lineOmegUnst.set_ydata(np.asarray(1.0/w)*solveLinStab(globalFreq(w,Kvco, AkPD, Ga1_slider.val, tauf_slider.val, v_slider.val, digital, maxp)['Omeg'],
						globalFreq(w, Kvco, AkPD, Ga1_slider.val, tauf_slider.val, v_slider.val, digital, maxp)['tau'], tauf_slider.val, Kvco, AkPD, Ga1_slider.val, tauc_slider.val, v_slider.val, digital,maxp, expansion)['OmegUnst']);
	lineOmegUnst.set_xdata(np.asarray(1.0/(2.0*np.pi))*solveLinStab(globalFreq(w, Kvco, AkPD, Ga1_slider.val, tauf_slider.val, v_slider.val, digital, maxp)['Omeg'],
						globalFreq(w, Kvco, AkPD, Ga1_slider.val, tauf_slider.val, v_slider.val, digital, maxp)['tau'], tauf_slider.val, Kvco, AkPD, Ga1_slider.val, tauc_slider.val, v_slider.val, digital,maxp, expansion)['tauUnst']*solveLinStab(globalFreq(w, Kvco, AkPD, Ga1_slider.val, tauf_slider.val, v_slider.val, digital, maxp)['Omeg'],
						globalFreq(w, Kvco, AkPD, Ga1_slider.val, tauf_slider.val, v_slider.val, digital, maxp)['tau'], tauf_slider.val, Kvco, AkPD, Ga1_slider.val, tauc_slider.val, v_slider.val, digital,maxp, expansion)['OmegUnst']);
	...
	globalFreq(w, Kvco, AkPD, Ga1_slider.val, tauf_slider.val, v_slider.val, digital, maxp)['tau'], tauf_slider.val, Kvco, AkPD, Ga1_slider.val, tauc_slider.val, v_slider.val, digital,maxp, expansion)['Re']);
	...
	globalFreq(w, Kvco, AkPD, Ga1_slider.val, tauf_slider.val, v_slider.val, digital, maxp)['tau'], tauf_slider.val, Kvco, AkPD, Ga1_slider.val, tauc_slider.val, v_slider.val, digital,maxp, expansion)['Im']);
