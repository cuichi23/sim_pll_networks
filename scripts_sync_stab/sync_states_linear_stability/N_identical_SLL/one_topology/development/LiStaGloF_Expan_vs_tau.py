...
tauf_slider     = Slider(tauf_slider_ax, '$\omega$tauf/$2\pi$', 0.0, 25/w, valinit=tauf_0)#25*(2.0*np.pi/w)
# Draw another slider
K_slider_ax = fig.add_axes([0.25, 0.04, 0.65, 0.02], facecolor=axis_color)
K_slider    = Slider(K_slider_ax, 'K/$\omega$', 0.001*w, 1.5*w, valinit=K_0)
# Draw another slider
tauc_slider_ax  = fig.add_axes([0.25, 0.01, 0.65, 0.02], facecolor=axis_color)
tauc_slider     = Slider(tauc_slider_ax, 'tauc/$\omega$', 0.05*(1.0/w), 10.0*(1.0/w), valinit=tauc_0)
