...
def getDicts(Fsim=55):
	...
	dict_algo={
		'parameter_space_sweeps': 'single',									# pick method for setting realizations 'single', 'classicBruteForceMethodRotatedSpace', 'listOfInitialPhaseConfigurations', 'single', 'statistics'
