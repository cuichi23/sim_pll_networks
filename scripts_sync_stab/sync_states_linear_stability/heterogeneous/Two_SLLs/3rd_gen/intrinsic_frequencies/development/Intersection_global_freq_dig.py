...
def integrationdigital(wmean,Dw, Kvco, AkPD, Ga1, v):

    # a piece of a prolate cycloid, and am going to find
    a, b = 1, 2
    tau= np.linspace(0.0, 86.788706E-9, 100000)#4.788706E-9#
...
# plt.plot((wmean/(2.0*np.pi))*integrationdigital(wmean,Dw, Kvco, AkPD, Ga1, v)['Tau'][np.where(integrationdigital(wmean,Dw, Kvco, AkPD, Ga1, v)['betadig']!=0)],integrationdigital(wmean,Dw, Kvco, AkPD, Ga1, v)['betadig'],'*k')
